  ...
  (function($, window) {
    ...
    BootstrapSwitch = (function() {
      ...
      BootstrapSwitch.prototype.destroy = function() {
        ...
        if ($form.length) {
          $form.off("reset.bootstrapSwitch").removeData("bootstrapswitch");
        }
        this.$container.children().not(this.$element).remove();
        this.$element.unwrap().unwrap().off(".bootstrapSwitch").removeData("bootstrapswitch");
        return this.$element;
      };
      ...
      BootstrapSwitch.prototype._formHandler = function() {
        var $form;
        $form = this.$element.closest("form");
        if ($form.data("bootstrapswitch")) {
          return;
        }
        return $form.on("reset.bootstrapSwitch", function() {
          return window.setTimeout(function() {
            return $form.find("input").filter(function() {
              return $(this).data("bootstrapswitch");
            }).each(function() {
    ...
    $.fn.bootstrapSwitch = function() {
      ...
      this.each(function() {
        ...
        if (!data) {
          $this.data("bootstrapswitch", data = new BootstrapSwitch(this, option));
        }
